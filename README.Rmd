...
tested levels, inference grid, maximum separation and its time, p-value,
q-value, and inferential limitation. Trajectory-difference tests use a maximum
standardized fitted-contrast statistic calibrated from the model covariance;
they do not select the smallest p-value among group-specific smooth terms.
